...
df_study1 <- 
  df_study1_long_t7 %>%
  select(idencuesta,ola,comuna, region_cod, ponderador_long_total, marchar, part_com, satisfaccion_seguridad, starts_with("barrio_"), jjvv_prom, org_religiosa_prom, org_deportiva_prom, educ, quintil1, ess, edad, sexo, pos_id) %>% 
  na.omit() %>% 
...
h16.2 <- "edad*ola+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h17 <- "ola*satisfaccion_seguridad+edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h17.2 <- "ola+satisfaccion_seguridad*edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h18 <- "edad*satisfaccion_seguridad*ola+edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h19 <- "ola+attachment*edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h20 <- "edad*attachment*ola+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h21 <- "ola+sociabilidad*edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h22 <- "edad*sociabilidad*ola+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"

h23 <- "ola+part_com*edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h24 <- "edad*part_com*ola+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h25 <- "ola+jjvv_prom*edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h26 <- "edad*jjvv_prom*ola+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h27 <- "ola+org_religiosa_prom*edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h28 <- "edad*org_religiosa_prom*ola+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h29 <- "ola+org_deportiva_prom*edad+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
h30 <- "edad*org_deportiva_prom*ola+rm+satisfaccion_seguridad+attachment+sociabilidad+part_com+jjvv_prom+org_religiosa_prom+org_deportiva_prom+educ+quintil1+sexo+ess+pos_id"
...
marchar16.2 <- lmer(formula(paste0("marchar~",h16.2,"+(1|idencuesta)")),data = df_study1, weights = ponderador_long_total)
...
#omit <- "(pos_id)|(edad)|(cuestion_mig)|(nation_t1)|(quintil1QNA)|(Intercept)"
texreg::htmlreg(list(marchar16, marchar17, marchar17.2, marchar18, marchar19, marchar20,
                     marchar21,marchar22,marchar23,marchar24,marchar25,marchar26,marchar27,marchar28, marchar29, marchar30),
                custom.note = "*** p < 0.001; ** p < 0.01; * p < 0.05", 
#                custom.coef.names = c("Intercepto",
#                                      "ola 2017 <br> <i>(Ref. ola 2016)</i>",
#                                      "ola 2018",
...
```{r}
sjPlot::plot_model(marchar16.2, type = "int", mdrt.values = "meansd")
```

ola x satisfaccion_seguridad
...
```{r}
sjPlot::plot_model(marchar28, type = "int", mdrt.values = "meansd")
```

ola x org deportivas

```{r}
sjPlot::plot_model(marchar29, type = "int", mdrt.values = "meansd")
```

ola x org deportivas x edad

```{r}
sjPlot::plot_model(marchar30, type = "int", mdrt.values = "meansd")
```
